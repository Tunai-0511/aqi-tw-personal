#!/usr/bin/env python3
"""Record a Discord `feel 1~5` check-in into LobsterAQI's health diary.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Record Discord feel check-in into LobsterAQI health_diary")
