"""
資料層 (Data Layer) — AgentAQI 的核心資料模組
============================================================
...
class CleaningReport:
    ...
    drop_reasons:   dict[str, int]       # 各種丟棄原因的計數,例:{"PM2.5 異常": 25, "地理範圍外": 12, "重複": 3}
...
# 用途:注入 LLM prompt + 寫進個人 RAG,讓 AI 助理 / 預警員給專屬診斷碼建議。
USER_ICD10_OPTIONS = [
...
# =============================================================================
# 設計取捨:用 agent gateway 統一管理 LLM 雖然優雅,但每次呼叫多 30-60 秒
